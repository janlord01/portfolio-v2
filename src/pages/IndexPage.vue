      ...
      <div class="row q-col-gutter-lg">
        <div class="col-12 col-sm-4 large-screen-only">
          <q-item
            ...
            :style="
              $q.screen.gt.sm ? 'width: 400px;top:20px;' : 'max-width: 400px;'
            "
          >
            <q-item-section
              avatar
            ...
            >
              <template v-if="settingStore.loading">
                <q-skeleton
                  type="QAvatar"
                  :size="$q.screen.gt.sm ? '100px' : '120px'"
                />
              </template>
                ...
                <template v-if="settingStore.loading">
                  ...
                  <template v-if="$q.screen.gt.sm">
                    <q-item
                      ...
                      :class="row === 1 ? 'q-mt-md' : ''"
                    >
                      <q-item-section v-for="col in 4" :key="col" avatar>
                ...
                <template v-else>
                  ...
                  <span
                    ...
                    ><q-icon name="location_on" />{{
                      userStore.userData.address || "Davao City, Philippines"
                    }}
                  </span>
                  <q-btn
                    color="primary"
                  ...
                  <q-btn
                    ...
                    :size="$q.screen.gt.sm ? 'sm' : 'sm'"
                    v-if="userStore.userData.email"
                    href="https://www.instagram.com/janlordluga/"
                    unelevated
                    round
                    icon="mdi-instagram"
                    flat
                  ...
                  <q-btn
                    ...
                    :size="$q.screen.gt.sm ? 'sm' : 'sm'"
                    v-if="userStore.userData.email"
                    href="https://www.linkedin.com/in/janlord-luga-a778503a/"
                    unelevated
                    round
                    icon="mdi-linkedin"
                    flat
                  ...
                  >
                    {{
                      settingStore.settingsData.caption ||
                      "I build solutions that are both fun and efficient."
                    }}
                  </p>
                  <div
                    :style="$q.screen.gt.sm ? 'display:block;' : 'display:none'"
                  ...
                  <div :style="$q.screen.gt.sm ? 'margin-top: -10px;' : ''">
                    <q-btn
                      ...
                      :class="$q.screen.gt.md ? 'q-mt-lg' : 'q-mt-sm'"
                      color="primary"
                      v-if="userStore.userData.cv"
                      flat
                      dense
                      :href="userStore.userData.cv ? userStore.userData.cv : ''"
                      icon="mdi-download"
                      target="_blank"
                    ...
                    <q-btn
                      ...
                      :class="$q.screen.gt.md ? 'q-mt-lg' : 'q-mt-sm'"
                      color="primary"
                      v-if="newToken && userStore.userData.cv"
                      flat
                      dense
                      :size="$q.screen.gt.md ? 'sm' : 'sm'"
                    />
          ...
          <template v-if="settingStore.loading">
            ...
            <q-skeleton
              ...
              style="display: block; margin: -80px auto"
            />
            <div v-if="!$q.screen.gt.sm" style="margin-top: 120px">
              <q-skeleton
                type="QToolbar"
                width="100px"
                class="q-mt-xl"
              ...
              <q-item
                v-for="row in 3"
                :key="row"
                :class="row === 1 ? 'q-mt-md q-ml-xl' : 'q-ml-xl'"
              >
                <q-item-section v-for="col in 4" :key="col" avatar>
                  <q-skeleton type="QAvatar" />
                </q-item-section>
                ...
                >
                  <div v-if="loading" class="row full-width">
                    <q-card
                      ...
                      bordered
                      :style="
                        $q.screen.gt.md ? 'flex-basis: 48%;' : 'width: 100%'
                      "
                    >
                      <q-item>
