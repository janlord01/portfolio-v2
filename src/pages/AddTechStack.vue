  ...
  <q-page class="q-pa-md">
    <q-card class="q-pa-md">
      <q-form @submit="submitForm" @reset="resetForm">
        <q-card-section>
          <div class="text-h6">Add {{ settingStore.settingsData.tech_title || 'New tech' }} </div>
        </q-card-section>
        ...
        <q-card-section>
          ...
          <!-- <q-input filled v-model="tech.tech" label="Task" hint="Separate technologies with commas" class="q-mt-md q-mb-md" /> -->
...
const submitForm = async () => {
  ...
  // formData.append('url', tech.value.url);
  // formData.append('caption', tech.value.caption);
  // formData.append('sub_caption', tech.value.sub_caption);
